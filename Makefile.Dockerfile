...
HTSPATH=htslib-1.16/libhts.a
HTSFLAGS=$(HTSPATH) -I htslib-1.16 -I ./ -pthread -lm -lz -lbz2 -llzma -lcurl # -lcrypto # can be changed depending on the specific installed components of htslib (please refer to the INSTALL file in htslib)
